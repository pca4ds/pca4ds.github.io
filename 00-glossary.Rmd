...
- __Contribution__: measures the participation of an element (e.g. modality, variable, frequency, or individual) in the construction of a factorial axis.

- __Squared Cosine__: measures the quality of the projection of an element (e.g. modality, variable, frequency, or individual) along a factorial axis.

- __V-test__: measures, in number of standard deviations, the distance between an observed value and its theoretical value under a null hypothesis. This test is used to characterize the axes, the modelities, the classes, etc.
