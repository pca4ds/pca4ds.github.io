...
```{r table-4-8, echo = FALSE, comment = ''}
options(knitr.kable.NA = '')
cor_4_8 <- cbind(
...
rownames(cor_4_8) <- c('color', 'lackluster', 'cracks', 'thickness', 'wrinkles')
colnames(cor_4_8) <- c('color', 'lackluster', 'cracks', 'thickness', 'wrinkles')

cor_4_8[upper.tri(cor_4_8, diag = FALSE)] <- NA
...
knitr::kable(
  ...
  booktabs = TRUE,
  caption = 'Correlations Matrix of 5 Active Variables'
)
```
