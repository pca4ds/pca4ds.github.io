...
If we use the _raw_ data (i.e. mean-centered only, no scaling by the standard deviation), the squared distance of one variable to the origin is given by:
...
which coincides with \@ref(eq:17) when using mean-centered data and standardized (normalized PCA), or with \@ref(eq:16) when using non-centenred data 
(non-normalized PCA; \@ref(eq:11) and \@ref(eq:21)).
