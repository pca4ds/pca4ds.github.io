...
- _Distance between individuals_: classic (squared) euclidean distance (sum of the squares of the differences with centered data).
...
if the individuals with such categories have answered in a similar way the set of active variables.
